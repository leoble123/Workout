...
object ExerciseSeed {
    ...
    val all: List<ExerciseEntity> = listOf(
        ...
        ex("skull_crusher", "Skull Crusher", Muscle.TRICEPS, Equipment.EZ_BAR, MovementPattern.ISOLATION, 8, 12),
        ...
        ex("preacher_curl", "Preacher Curl", Muscle.BICEPS, Equipment.EZ_BAR, MovementPattern.ISOLATION, 8, 12),
        ...
        ex("dumbbell_hip_thrust", "Dumbbell Hip Thrust", Muscle.GLUTES, Equipment.DUMBBELL, MovementPattern.HINGE, 10, 15, secondary = listOf(Muscle.HAMSTRINGS)),
        ex("chest_supported_dumbbell_shrug", "Chest-Supported Dumbbell Shrug", Muscle.TRAPS, Equipment.DUMBBELL, MovementPattern.ISOLATION, 12, 20),
